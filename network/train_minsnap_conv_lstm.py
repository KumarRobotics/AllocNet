...
class MinSnapNetworkTrainingManager():
    def __init__(self, config_dir):
        ...
        dataset = ConvMultiMapMinSnapDataset(self.dataset_dir, seq_len=self.seq_len)
        # Prepare dataloaders
        ...
        self.model = ConvLSTMMinimalSnapNetwork(seg=seg,
                                        ...
                                        loss_dim_reduction=loss_dim_reduction, w1=w1, wt=wt, wc=wc, wp=wp, seq_len=self.seq_len)
