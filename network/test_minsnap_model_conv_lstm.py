...
scripted_model_dir = models_dir + "/scripted" + str(model_idx) + ".pt"
...
def main():
    ...
    scripted_model = torch.jit.load(scripted_model_dir)

    print("shape of stacked_state: ", stacked_state.shape)
    print("shape of stacked_hpolys: ", stacked_hpolys.shape)

    scripted_output_tf = scripted_model(stacked_state, stacked_hpolys)

    print("===== scripted_output_tf: ", scripted_output_tf)
