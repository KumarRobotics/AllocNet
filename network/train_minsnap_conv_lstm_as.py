...
from utils.learning.minsnap_network_conv_lstm_as import ConvLSTMMinimalSnapNetwork
...
class MinSnapNetworkTrainingManager():
    def __init__(self, config_dir):
        ...
        s_last_epoch = config["scheduler"]["lasRt_epoch"]
        ...
        self.model = ConvLSTMMinimalSnapNetwork(seg=seg,
                                        ...
                                        loss_dim_reduction=loss_dim_reduction, w1=w1, wt=wt, wc=wc, wp=wp)
    ...
    def train_one_epoch(self):
        ...
        for i, data in enumerate(self.training_dataloader):
            ...
            curr_obj_val, curr_obj1_val, curr_objt_val, curr_objc_val, curr_success_rate, objt_debug_log, stop_token_loss_val = \
            ...
            self.writer.add_scalar("stop_token_loss_val training / iteration", stop_token_loss_val, self.curr_step_idx)
...
if __name__ == '__main__':
    config_dir = "configs/minsnap_conv_lstm_params.yaml"
