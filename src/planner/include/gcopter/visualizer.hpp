...
public:
        ...
        : nh(nh_)
    {
        ...
        textPub = nh.advertise<visualization_msgs::Marker>("/visualizer/text", 1000);
    ...
    inline void visualizePolytope(const std::vector<Eigen::MatrixX4d> &hPolys)
    {
        ...
        edgeMarker.color.g = 0.2;
        edgeMarker.color.b = 1.00;
        edgeMarker.color.a = 0.7;
    ...
    inline void visualizeText(const std::string &str)
    {
        ...
        textMaker.pose.position.x = -15.0;
        textMaker.pose.position.y = -7.0;
        textMaker.pose.position.z = 0.0;
        textMaker.text = str;
        textMaker.color.r = 0.00;
        textMaker.color.g = 0.00;
        textMaker.color.b = 0.00;
        textMaker.color.a = 1.00;
        textMaker.scale.x = 1.0;
        textMaker.scale.y = 1.0;
        textMaker.scale.z = 1.0;
                                   ...
                                   const int sg)
    {
        ...
        sphereMarkers.color.r = 0.7;
        sphereMarkers.color.g = 0.3;
